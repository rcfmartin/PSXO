function Remove-XoServer
{
    ...
    Remove-XoServer -Session $sess -Id "a933cb47-fbf7-42a5-af39-abac9fc3feca"
    ...
    process
    {
        if ($PSCmdlet.ShouldProcess($Id, "Remove Server"))
        {
            ...
            try
            {
                $body = New-JsonRpcRequest -Method "server.remove" -Params $params
