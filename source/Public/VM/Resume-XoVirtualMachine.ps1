function Resume-XoVirtualMachine
{
    <#
    .SYNOPSIS
    Resumes virtual machine
    ...
    Resume-XoVirtualMachine -Session $sess -Id "06754190-adbf-46a9-ab00-558ffcc9a22f"
    #>
    [CmdletBinding()]
    [OutputType([void])]
    param (
    ...
    process
    {
        ...
        try
        {
            $body = New-JsonRpcRequest -Method "vm.resume" -Params $params
        ...
        if ($resp)
        {
            $prop = $resp.params.items.psobject.Properties.Value | Where-Object { $_.name_label -ilike "*VM.resume*" }
