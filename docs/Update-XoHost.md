...
```
Update-XoHost [-Session] <XoSession> [-Id] <String> [[-NameLabel] <String>] [[-NameDescription] <String>]
 [[-IscsiIqn] <String>] [[-MultiPathing] <Boolean>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
